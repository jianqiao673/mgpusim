...
var memoryTracing = flag.Bool("trace-memory", false,
	"Generate memory trace for the simulation. This is different from "+
	" -trace-mem, which is used for the AkitaRTM visualization. "+
